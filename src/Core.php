...
final class Core {
    public const REST_NAMESPACE = 'yellowstep-editor/v3';
    public const ABILITY_CATEGORY = 'yellowstep-editor';
    ...
    public static function postCheck(int $postId) {
        ...
        if (!$post || !current_user_can('edit_post', $postId)) { return new WP_Error('not_found', 'Post not found or not editable.', ['status' => 404]); }
        return $post;
    }
